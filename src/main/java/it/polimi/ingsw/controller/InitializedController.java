...
public class InitializedController extends Observable implements ControllerObserver {
    ...
    public void createGame(){
        ...
        if (numberOfPlayer==1){
            ...
            turnSequence.get(1).setGameSpace(soloPersonalBoard);
    ...
    private void chooseLeaderCard(boolean solo){
        ...
        if (solo){
            ...
            VChooseLeaderCardRequestMsg msg = new VChooseLeaderCardRequestMsg("Ask the client to choose 2 from 4 Leader Cards",fourLeaderCard, turnSequence.get(1).getUsername());
    ...
    public void receiveMsg(CChooseLeaderCardResponseMsg msg) {
        ...
        for (int i= 0; i<2; i++){
            if (boardManager.getAllLeaderCard().contains(twoChosen.get(i))){
                ...
                LeaderCard chosen = boardManager.getLeaderCardDeck().getLederCardById(twoChosen.get(i));
