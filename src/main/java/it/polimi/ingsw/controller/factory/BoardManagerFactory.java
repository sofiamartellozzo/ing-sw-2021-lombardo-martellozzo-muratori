...
public class BoardManagerFactory {
    ...
    protected DevelopmentCardDeck[][] createDevelopmentDeckTable(){
        ...
        DevelopmentCard card1 = new DevelopmentCard(3,Color.GREY,1,array,proceeds,cost);
        DevelopmentCard card2 = new DevelopmentCard(2,Color.GREY,1,array,proceeds,cost);
        DevelopmentCard card3 = new DevelopmentCard(6,Color.GREY,1,array,proceeds,cost);
        DevelopmentCard card4 = new DevelopmentCard(3,Color.GREY,1,array,proceeds,cost);
        ...
        DevelopmentCard card91 = new DevelopmentCard(3,Color.GREY,1,array,proceeds,cost);
        DevelopmentCard card92 = new DevelopmentCard(2,Color.GREY,1,array,proceeds,cost);
        DevelopmentCard card93 = new DevelopmentCard(6,Color.GREY,1,array,proceeds,cost);
        DevelopmentCard card94 = new DevelopmentCard(3,Color.GREY,1,array,proceeds,cost);
        ...
        DevelopmentCard card81 = new DevelopmentCard(3,Color.GREY,1,array,proceeds,cost);
        DevelopmentCard card82 = new DevelopmentCard(2,Color.GREY,1,array,proceeds,cost);
        DevelopmentCard card83 = new DevelopmentCard(6,Color.GREY,1,array,proceeds,cost);
        DevelopmentCard card84 = new DevelopmentCard(3,Color.GREY,1,array,proceeds,cost);
